<div class="my-8 space-y-10">
    @if ($successMessage)
    <div class="rounded-md bg-green-50 p-4 my-8 mx-4">
        <div class="flex">
    ...
    @endif
    <form wire:submit.prevent="postComment" {{--action="/comment"--}} method="POST" class="w-1/2 my-12 p-3">
        @csrf
        <div class="flex">
            <img class="h-10 w-10 rounded-full" src="https://www.gravatar.com/avatar/?d=mp&f=y" alt="avatar">
            <div class="ml-4 flex-1">
                {{-- <input wire:model="postId" type="hidden" name="post_id"> --}}
                <textarea wire:model="body" name="body" id="body" rows="4" placeholder="Type your comment here..."
    ...
    <div class="flex p-4">
        ...
        <div class="ml-4">
            <div class="flex items-center">
                <div class="font-semibold">Billy</div>
